...
class Protocol:
    ...
    def PowerOn(self):
        ...
        self.Cmd_event = b'\x50\x57\x4F\x4E'
        self.SubCmdID = b'\x02' # 전원 ON
        self.len = b'\x00'
        self.program_id = b'\x00\x00\x00\x00\x00'
        return self.FixedStart() + self.PowerOn() + self.program_id + self.FixedEnd()
    ...
    def PowerOFF(self):
        ...
        self.Length = b'\x00'
        self.program_id = b'\x00\x00\x00\x00\x00'
        self.OFF = self.FixedStart() + self.PowerOFF() + self.program_id + self.FixedEnd()
        return self.OFF
